...
for node, centrality in sorted(list(temporal_centrality.items()),key=lambda x: x[1], reverse=True):
    year, code = node.split('_')
    yrs[year].append(iso2country[code])
```
